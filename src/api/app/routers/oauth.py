...
async def method_oauth_authorize(client_id: int, state: str, redirect_uri: str, scope: str, response_type: str,
                                 db: Session = Depends(get_db),
                                 settings: Settings = Depends(get_settings)) -> JSONResponse | RedirectResponse:
...
async def method_oauth_access_token(req: Request,
    ...
    if grant_type == "password":
        return api_error(ApiErrorCode.API_NOT_IMPLEMENTED,
    ...
    return api_error(ApiErrorCode.API_INVALID_REQUEST,
