...
def register_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(RequestValidationError, _handlers.validation_exception_handler)

    app.add_exception_handler(TokenExpiredError, _handlers.token_expired_error_handler)
    app.add_exception_handler(TokenWrongTypeError, _handlers.token_wrong_type_error_handler)
    app.add_exception_handler(TokenInvalidError, _handlers.token_invalid_error_handler)
    app.add_exception_handler(TokenInvalidSignatureError, _handlers.token_invalid_signature_error_handler)
