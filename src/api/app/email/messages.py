...
async def send_verification_email(background_tasks: BackgroundTasks, email: str, mention: str, confirmation_link: str):
...
async def send_verification_end_email(background_tasks: BackgroundTasks, email: str, mention: str):
...
async def send_tfa_otp_email(background_tasks: BackgroundTasks, email: str, mention: str, otp: str):
