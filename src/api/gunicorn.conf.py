...
loglevel = "info" # (Default: Info) One of those: debug, info, warning, error, critical.
capture_output = False if _log_to_stdout else False  # (Default: False) Redirect stdout/stderr to specified file in errorlog.
...
max_requests_jitter = 1_000  # Jitter for `max_requests` to not restart all workers at once.
